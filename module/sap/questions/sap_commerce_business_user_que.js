...
window.questions = [
    {
        number: 1,
        question: "You want to feature a page on your storefront that can only be viewed by a special user group. What SAP Commerce user interface do you use to do this?",
        options: ["BackOffice Adaptive Search Perspective", "SmartEdit", "BackOffice Sales Organization Perspective", "BackOffice Product Cockpit"],
        multiselect: false
    },
    {
        number: 2,
    ...
    {
        number: 3,
        question: "You synchronize a media item stored in Hybris from a Staged version to an Online Version. What happens? (Choose 2 that apply)",
        options: [
    ...
    {
        number: 4,
        question: "Choose the macro definition for '$catalogversion' used in the below ImpEx header: INSERT_UPDATE Car;code=[unique=true]:name[lang=en]:unit(code);$catalogVersion",
        options: [
    ...
    {
        number: 6,
        question: "Your apparel store currently offers color and price range facets. Which attributes would also be appropriate for Solr faceting? (Choose 2 that apply)",
    ...
    },
    {
        ...
        options: ["LEFT JOIN and JOIN", "LEFT JOIN and RIGHT JOIN", "RIGHT JOIN and JOIN", "INNER JOINs"],
        multiselect: false
    },
    {
        number: 8,
        question: "Which user interfaces can be used to change prices? (Choose 2 that apply)",
        options: ["Backoffice Product Cockpit", "Backoffice Administration Cockpit", "SmartEdit", "Backoffice Customer Support Cockpit"],
        multiselect: true
    },
    {
        number: 9,
        question: "A customer wants to extend the functionality of the SAP Commerce Accelerator without touching its core code base. What solution do you suggest?",
    ...
    {
        number: 11,
        question: "What happens when you roll back to a saved version of a page in SmartEdit? (Choose 2 answers that apply)",
        options: [
    ...
    {
        number: 12,
        question: "You have been asked to import some data using ImpEx scripts that create user interface components on a storefront. What tool would you use to execute the ImpEx scripts?",
        options: ["Product Cockpit", "Order Fulfillment Cockpit", "Hybris Administration Console", "SmartEdit"],
        multiselect: false
    },
    {
        number: 13,
        question: "Which restriction type is NOT available out-of-the-box for page components?",
        options: ["Category Restriction", "Time Restriction", "IP Address Restriction", "Usergroup Restriction"],
        multiselect: false
    },
    {
        number: 14,
        question: "What actions can you perform using the Advanced Edit mode of SmartEdit? (Choose 2 correct options)",
        options: [
    ...
    {
        number: 15,
        question: "When 2 promotions (promotion engine) have the same priority how does SAP Commerce order them?",
        options: ["alphabetically", "can't be determined", "date of creation", "aid"],
        multiselect: false
    },
    {
        number: 16,
        question: "You want to implement an automated CronJob to be executed every day at midnight. What steps do you take to achieve this? (Choose 2 correct answers)",
        options: [
    ...
    {
        number: 17,
        question: "What can you directly do in the BackOffice Administration Cockpit? (Choose 2 correct options)",
        options: [
    ...
    {
        number: 19,
        question: "Where can you configure the Availability to Promise formulas in SAP Commerce Cloud?",
        options: [
